...
export const updateCommand = new Command('update')
    ...
    try {
        ...
        updatedFiles.push('.github/skills/figma-extraction/SKILL.md', '.github/skills/orval-hooks/SKILL.md', '.github/skills/frontend-spec/SKILL.md', '.github/skills/validation-loop/SKILL.md');
