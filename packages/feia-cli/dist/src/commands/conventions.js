...
conventionsCommand
    ...
    try {
        ...
        const conventions = YAML.parse(content);
        logger.title('Convenções do Projeto');
        logger.newLine();
        // Stack
        const stack = conventions['stack'];
        if (stack) {
        ...
        // Imports
        const imports = conventions['imports'];
        if (imports) {
            console.log(chalk.bold('\nImports:'));
        ...
        // Components
        const components = conventions['components'];
        if (components) {
            console.log(chalk.bold('\nComponents:'));
        ...
        // Custom
        const custom = conventions['custom'];
