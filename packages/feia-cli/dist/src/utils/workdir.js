 ...
 */
export function isValidNodeProject(dir = process.cwd()) {
 ...
 */
export function validateWorkingDirectory(dir = process.cwd()) {
 ...
 */
export function getPackageJsonPath(dir = process.cwd()) {
    return path.join(dir, 'package.json');
}
/**
 * Lê e retorna o package.json do diretório especificado
 */
export async function readPackageJson(dir = process.cwd()) {
    try {
